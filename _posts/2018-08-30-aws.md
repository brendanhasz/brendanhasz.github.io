...
We'll use the `yum` program to install docker.  First update `yum` by running (within your shell after SSH-ing into your instance):
...
## Run Code or a Notebook on an EC2 Instance 
