...
This will allow you to access anything in the `dir-to-share-in-host` folder on the host instance from the `dir-to-share-in-container` folder inside the docker container!
