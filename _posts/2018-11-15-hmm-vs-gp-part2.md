...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-60-1.svg)
...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-62-1.svg)
...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-69-1.svg)
...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-80-1.svg)
...
The chains converged for all four fits (Rhat values look good are near
1 if we view the fits), 
and the number of effective samples look OK for the parameters of
interest, though we may want to run sampling for more iterations than
the default (notice that the effective number of samples for the
population mean parameters `phi_m` and `theta_m` are closer to 1000 than
4000). Let's take a look at the HMC diagnostics.
...
```
    ...
    Divergences:
    15 of 4000 iterations ended with a divergence (0.375%).
...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-83-1.svg)
...
![](/assets/img/hmm-vs-gp-part2/unnamed-chunk-91-1.svg)
